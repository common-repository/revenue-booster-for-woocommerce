...
/**
 * DSRBFW_OB_Before_Order_List_Table class.
 *
 * @extends WP_List_Table
 */
if ( ! class_exists( 'DSRBFW_OB_Before_Order_List_Table' ) ) {

	class DSRBFW_OB_Before_Order_List_Table extends WP_List_Table {
		...
		public function __construct() {
			parent::__construct( array(
				'singular' => 'dsrbfw_before_order',
				'plural'   => 'dsrbfw_before_orders',
				'ajax'     => false
			) );
		}
		...
		public function column_product( $item ) {
            ...
            $product_id 		= get_post_meta( $item->ID, 'dsrbfw_ob_bo_product', true );
		...
		public function column_status( $item ) {
            ...
            if( !empty( $rule_status ) ) {
                ?>
                <label class="switch">
                    <input type="checkbox" class="status_switch" name="dsrbfw_ob_bo_status" value="on" <?php checked( 'publish', $rule_status, true ); ?> data-obid="<?php echo esc_attr( $item->ID ); ?>">
		...
		public function no_items() {
            esc_html_e( 'No before order\'s order bump found!', 'revenue-booster-for-woocommerce' );
		}
		...
		public function prepare_items() {
			...
			$per_page = $this->get_items_per_page( 'dsrbfw_ob_before_order_per_page' );
		...
		public static function dsrbfw_find( $args = '' ) {
			...
			$args['post_type'] = DSRBFW_AFTER_OB_POST_TYPE;
		...
		public function process_bulk_action() {
            ...
            if( !empty( $nonce ) ){
                ...
                switch ( $action ) {
                    ...
                    case 'delete':
                        foreach ( $items as $dsrbfw_ob_bo_id ) {
                            wp_delete_post( $dsrbfw_ob_bo_id );
                        }
